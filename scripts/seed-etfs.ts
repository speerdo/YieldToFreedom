...
const ETF_UNIVERSE = [
  ...
  { ticker: 'KLIP',  name: 'KraneShares China Internet and Covered Call Strategy ETF', pillar: 'income',  category: 'high-yield',     incomeSynthetic: false },
  { ticker: 'CSHI',  name: 'NEOS Enhanced Income Cash Alternative ETF',             pillar: 'income',    category: 'high-yield',     incomeSynthetic: true  },
  { ticker: 'HNDL',  name: 'Strategy Shares Nasdaq 7HANDL Index ETF',               pillar: 'income',    category: 'high-yield',     incomeSynthetic: false },
  ...
  { ticker: 'TOPW',  name: 'Roundhill Weekly Pay ETF',                             pillar: 'income',    category: 'high-yield',     incomeSynthetic: false },
  { ticker: 'GOOW',  name: 'Roundhill GOOGL WeeklyPay ETF',                        pillar: 'income',    category: 'high-yield',     incomeSynthetic: false },
  { ticker: 'NVII',  name: 'REX NVDA Growth & Income ETF',                         pillar: 'income',    category: 'high-yield',     incomeSynthetic: false },
